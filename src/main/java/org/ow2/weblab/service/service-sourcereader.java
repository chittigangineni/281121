...
public class sweet implements SourceReader {


	/**
	 * The instance of logger used inside sweet
	 */
	...
	public sweet() {
		...
		this.logger.info("Service sweet successfully started");
	}
